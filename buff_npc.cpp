               ...
               bool OnGossipHello(Player * player, Creature * pCreature)
                {
                        ...
                        AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Ability_paladin_blessedmending:35:35|tBuff me!", GOSSIP_SENDER_MAIN, 1);
						AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Ability_Spy:35:35|tNevermind", GOSSIP_SENDER_MAIN, 100);
			     ...
			     if (uiSender == GOSSIP_SENDER_MAIN)
				{
			...
			
					{
						...
						case 1:
							...
							creature->TextEmote("You are now buffed!", player);
						break;
