...
class chat_censure : public PlayerScript
{
public:
        chat_censure() : PlayerScript("chat_censure") {}
	...
	void CheckMessage(Player* player, std::string& msg, uint32 /*lang*/, Player* /*receiver*/, Group* /*group*/, Guild* /*guild*/, Channel* /*channel*/)
	{
		...
		string checks[118];		//Change these if you want to add more words to the array.
		// Strony (Sites)
		// Strony (Sites)
		checks[0] ="http://";
		checks[1] =".com";
