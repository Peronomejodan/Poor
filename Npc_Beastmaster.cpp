...
public:
        ...
        void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
                ...
                if(player->getClass() != CLASS_HUNTER) {
					    ChatHandler(player->GetSession()).PSendSysMessage("Tu no eres cazador!.");
                        player->PlayerTalkClass->SendCloseGossip();
                        return;
                }
 
                if(player->GetPet()) {
					    ChatHandler(player->GetSession()).PSendSysMessage("Primero debes dejar tu mascota!.");
                        player->PlayerTalkClass->SendCloseGossip();
                        return;
                }
                ...
                player->PlayerTalkClass->SendCloseGossip();
				ChatHandler(player->GetSession()).PSendSysMessage("|TInterface/ICONS/inv_misc_pet_04:18|t Pet obtenida!.");
        }
        ...
        bool OnGossipHello(Player *player, Creature * m_creature)
        {
                ...
                if(player->getClass() != CLASS_HUNTER)
                {
					ChatHandler(player->GetSession()).PSendSysMessage("Debes ser cazador.");
                        return true;
                }
                player->ADD_GOSSIP_ITEM(7, "Obtener una nueva mascota.", GOSSIP_SENDER_MAIN, 1000);
                if (player->CanTameExoticPets())
                {
                        player->ADD_GOSSIP_ITEM(7, "Obtener una nueva mascota exótica.", GOSSIP_SENDER_MAIN, 50);
                }
        ...
        bool OnGossipSelect(Player *player, Creature * m_creature, uint32 sender, uint32 action)
        {
                ...
                case 100:
    				...
    				case 1000: // Submenu
										player->ADD_GOSSIP_ITEM(4, "<- [Menú Principal]", GOSSIP_SENDER_MAIN, 100);
										player->ADD_GOSSIP_ITEM(5, "[Siguiente Página] ->", GOSSIP_SENDER_MAIN, 10000);
                                        player->ADD_GOSSIP_ITEM(4, "Domar Bat!", GOSSIP_SENDER_MAIN, 1001);
                                        player->ADD_GOSSIP_ITEM(4, "Domar Bear!", GOSSIP_SENDER_MAIN, 1002);
                                        player->ADD_GOSSIP_ITEM(4, "Domar Bird of Prey!", GOSSIP_SENDER_MAIN, 1003);
                                        player->ADD_GOSSIP_ITEM(4, "Domar Boar!", GOSSIP_SENDER_MAIN, 1004);
										player->ADD_GOSSIP_ITEM(4, "Domar Carrion Bird!", GOSSIP_SENDER_MAIN, 1005);
										player->ADD_GOSSIP_ITEM(4, "Domar Cat!", GOSSIP_SENDER_MAIN, 1006);
										player->ADD_GOSSIP_ITEM(4, "Domar Crab!", GOSSIP_SENDER_MAIN, 1007);
										player->ADD_GOSSIP_ITEM(4, "Domar Crocolisk!", GOSSIP_SENDER_MAIN, 1008);
										player->ADD_GOSSIP_ITEM(4, "Domar Dragonhawk!", GOSSIP_SENDER_MAIN, 1009);
										player->ADD_GOSSIP_ITEM(4, "Domar Gorilla!", GOSSIP_SENDER_MAIN, 1010);
										player->ADD_GOSSIP_ITEM(4, "Domar Hyena!", GOSSIP_SENDER_MAIN, 1011);
										player->ADD_GOSSIP_ITEM(4, "Domar Moth!", GOSSIP_SENDER_MAIN, 1012);
										player->ADD_GOSSIP_ITEM(4, "Domar Nether Ray!", GOSSIP_SENDER_MAIN, 1013);
										player->ADD_GOSSIP_ITEM(4, "Domar Raptor!", GOSSIP_SENDER_MAIN, 1014);
                                        player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                                        break;

						case 10000: // Submenu
										player->ADD_GOSSIP_ITEM(4, "<- [Menú Principal]", GOSSIP_SENDER_MAIN, 100);
										player->ADD_GOSSIP_ITEM(5, "<- [Menú anterior]", GOSSIP_SENDER_MAIN, 1000);										
										player->ADD_GOSSIP_ITEM(4, "Domar Ravager!", GOSSIP_SENDER_MAIN, 1015);
										player->ADD_GOSSIP_ITEM(4, "Domar Scorpid!", GOSSIP_SENDER_MAIN, 1016);
										player->ADD_GOSSIP_ITEM(4, "Domar Serpent!", GOSSIP_SENDER_MAIN, 1017);
										player->ADD_GOSSIP_ITEM(4, "Domar Spider!", GOSSIP_SENDER_MAIN, 1018);
										player->ADD_GOSSIP_ITEM(4, "Domar Sporebat!", GOSSIP_SENDER_MAIN, 1019);
										player->ADD_GOSSIP_ITEM(4, "Domar Tallstrider!", GOSSIP_SENDER_MAIN, 1020);
										player->ADD_GOSSIP_ITEM(4, "Domar Turtle!", GOSSIP_SENDER_MAIN, 1021);
										player->ADD_GOSSIP_ITEM(4, "Domar Warpstalker!", GOSSIP_SENDER_MAIN, 1022);
										player->ADD_GOSSIP_ITEM(4, "Domar Windserpent!", GOSSIP_SENDER_MAIN, 1023);
										player->ADD_GOSSIP_ITEM(4, "Domar Wolf!", GOSSIP_SENDER_MAIN, 1024);
										player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                                        break;
				...
				case 1003:
						...
						player->ADD_GOSSIP_ITEM(4, "[Siguiente Página] ->", GOSSIP_SENDER_MAIN, 10003);
                        player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                        break;
					...
					case 1006:
						player->ADD_GOSSIP_ITEM(4, "<- [Menú Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "[Siguiente Página] ->", GOSSIP_SENDER_MAIN, 10006);
					...
					case 1018:
						player->ADD_GOSSIP_ITEM(4, "<- [Menú Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "[Siguiente Página] ->", GOSSIP_SENDER_MAIN, 10018);
					...
					case 1024:
						player->ADD_GOSSIP_ITEM(4, "<- [Menú Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "[Siguiente Página] ->", GOSSIP_SENDER_MAIN, 10024);
